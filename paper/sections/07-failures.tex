...
This one is worth reporting for a methodological reason. On two of the four
seeds tested, the same defective revision scored a perfect four structures out
of four and looked entirely healthy. It was visible only on maps where the
corridor had to cross awkward ground --- which is an argument for sweeping
seeds rather than fixing one, and for reporting the spread rather than the
best case.
