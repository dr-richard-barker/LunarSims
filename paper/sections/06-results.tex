...
\begin{table}[htbp]
\centering
\caption{Habitat availability by site class, over eight seeds each. Values are
medians, with the observed range in brackets where it is wide; a median over an
even sample averages the middle pair, hence the half values. Buildable surface
is essentially unconstrained everywhere; subsurface habitation is not.}
\label{tab:sites}
\begin{tabular}{lrrrrrr}
\toprule
site class & latitude & sun slope & buildable & ice tiles & bore sites & tube tiles \\
\midrule
polar    & $-85^\circ$ & 0.201 & 16{,}167 & 527 & 44.5 \, [20--86] & 60 \, [24--81] \\
highland & $-50^\circ$ & 0.489 & 16{,}134 & 383 &  1.5 \, [0--9]   &  0 \\
mare     & $-5^\circ$  & 0.859 & 16{,}297.5 &   2 &  0 \, [0--0]     &  0 \\
\bottomrule
\end{tabular}
\end{table}
...
substantial ice --- a median of 383 tiles, only a quarter fewer than polar ---
and yet a median of just $1.5$ legal bore sites, with two of the eight seeds
offering none at all and the best offering nine. The ice is there; it lies on
slopes, and a bore needs a level pad. Resource abundance and resource
\emph{accessibility} come apart, which is the sort of distinction a
whole-settlement model surfaces and a component model does not.
